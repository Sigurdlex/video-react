      ...
      value: function render() {
        ...
        return React.createElement(
          'button',
          {
            ...
            className: classnames(className, (_classNames = {}, babelHelpers.defineProperty(_classNames, 'video-react-icon-' + mode + '-' + seconds, true), babelHelpers.defineProperty(_classNames, 'video-react-' + mode + '-control', true), _classNames), 'video-react-control video-react-button video-react-icon'),
            onClick: this.handleClick
          },
          React.createElement(
            'span',
